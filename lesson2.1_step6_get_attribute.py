...
#проверяем значение атрибута disabled у активной кнопки Submit
    button = browser.find_element(By.CSS_SELECTOR,'.btn')
    button_disabled = button.get_attribute("disabled")
    print("value of button Submit: ", button_disabled)
    assert button_disabled is None, "Button is disabled"

#проверяем значение атрибута disabled у неактивной кнопки Submit после таймаута
    time.sleep(10)
    button_disabled = button.get_attribute("disabled")
